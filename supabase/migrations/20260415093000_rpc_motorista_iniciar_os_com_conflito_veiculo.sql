-- Ao iniciar uma OS do motorista, verifica conflito de veículo em execução.
-- Se existir outra OS em execução para o mesmo veículo, pode:
-- 1) retornar exigindo confirmação, ou
-- 2) encerrar automaticamente a OS conflitante e iniciar a nova.
