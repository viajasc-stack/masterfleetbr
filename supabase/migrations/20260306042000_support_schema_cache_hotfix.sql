-- Hotfix: alinhar assinatura da RPC de suporte e forçar reload do schema cache do PostgREST
...
-- Força PostgREST a recarregar cache de schema (tabelas/funções novas)
